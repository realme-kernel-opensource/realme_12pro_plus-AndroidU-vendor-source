	...
	sipa_dev_t *si_pa)
{
	...
	pr_debug("[debug][%s] %s: ch%d check trim. 0x20 = 0x%02x, 0x21 = 0x%02x, 0x22 = 0x%02x, crc_cal = %d, crc =%d\r\n",
		LOG_FLAG, __func__, si_pa->channel_num, trim[2], trim[1], trim[0], crc_cal, crc);
