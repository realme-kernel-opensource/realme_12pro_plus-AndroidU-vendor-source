...
static int sc8547a_cp_enable(struct oplus_chg_ic_dev *ic_dev, bool en)
{
	...
	if (en)
		ret = sc8547_write_byte(chip->client, SC8547_REG_09, SC8547_WATCHDOG_1S); /* WD:1000ms */
	else
		ret = sc8547_write_byte(chip->client, SC8547_REG_09, SC8547_WATCHDOG_DIS); /* dsiable wdt */
